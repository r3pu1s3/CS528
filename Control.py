...
# does live tracking
async def live_tracking(client, gc:Gaze_Classifier, closed_threshold = 0.15, open_threshold = 0.2, gesture_window = 3, gesture_cooldown=1.5):
    ...
    while(True):
        ...
        # yield control to asyncio event loop between frames
